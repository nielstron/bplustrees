...
On the result, we can apply lemmas \cref[lst:btree-extract-fringe]{\emph{bplustree\_extract\_fringe}} 
and \cref[lst:btree-view-split]{\emph{bplustree\_view\_split}}.
