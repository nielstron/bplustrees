...
and taking the time to discuss approaches to the assertion fiddling when splitting the \btree.
...
to express statements about the abstract tree
and concrete implementation.
The second part was their verification,
which went rather smooth for good approaches
on the abstract level but induced much headache
on the imperative reasoning level.
Since all functional concerns are covered by
the refinement relation, all that remains
is to show the refinement relation holds,
and this process is very technical
and mainly requires proof of thousands of small
